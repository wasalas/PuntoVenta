...
{
    public partial class frmUnidades_Medida_ed : Form
    {
        #region "Mis Variables"
        private int Estado_guarda;
        private EUnidades_Medida oDatos;
        public bool GraboDatos = false;
        #endregion

        #region "Metodos del Form"
        public frmUnidades_Medida_ed(int Opcion, EUnidades_Medida Datos)
        {
            InitializeComponent();
            this.Estado_guarda = Opcion;
            this.oDatos = Datos;
        }
        private void frmUnidades_Medida_ed_Load(object sender, EventArgs e)
        {
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            {
                Rpta = NUnidades_Medida.Guardar(this.Estado_guarda, this.oDatos);
                if (Rpta == "OK")
                {
