    ...
    public class DPunto_Venta
    {
        public DataTable Listado(byte estado, string texto)
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("spListado_Punto_Venta", SqlCon);
        ...
        public string Guardar(int opcion, EPunto_Venta oEntidad)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                SqlCon = Conexion.GetInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("spGuardar_Punto_Venta", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@opt_guarda", SqlDbType.Int).Value = opcion;
                Comando.Parameters.Add("@codigo", SqlDbType.Int).Value = oEntidad.Codigo_pv;
                Comando.Parameters.Add("@descripcion", SqlDbType.VarChar).Value = oEntidad.Descripcion_pv;
        ...
        public string Eliminar(int codigo)
        {
            ...
            {
                SqlCon = Conexion.GetInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("spEliminar_Punto_Venta", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
