    ...
    public class DFamilias
    {
        public DataTable Listado(byte estado, string texto)
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("spListado_Familias", SqlCon);
        ...
        public string Guardar(int opcion, EFamilias oEntidad)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                SqlCon = Conexion.GetInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("spGuardar_Familias", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
                Comando.Parameters.Add("@opt_guarda", SqlDbType.Int).Value = opcion;
                Comando.Parameters.Add("@codigo", SqlDbType.Int).Value = oEntidad.Codigo_fa;
                Comando.Parameters.Add("@descripcion", SqlDbType.VarChar).Value = oEntidad.Descripcion_fa;
