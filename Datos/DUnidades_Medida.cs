    ...
    public class DUnidades_Medida
    {
        public DataTable Listado(byte estado, string texto)
        {
            ...
            try
            {
                ...
                SqlCommand Comando = new SqlCommand("spListado_Unidades_Medida", SqlCon);
        ...
        public string Guardar(int opcion, EUnidades_Medida oEntidad)
        {
            string Rpta = "";
            SqlConnection SqlCon = new SqlConnection();
            try
            {
                SqlCon = Conexion.GetInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("spGuardar_Unidades_Medida", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
        ...
        public string Eliminar(int codigo)
        {
            ...
            {
                SqlCon = Conexion.GetInstancia().CrearConexion();
                SqlCommand Comando = new SqlCommand("spEliminar_Unidades_Medida", SqlCon);
                Comando.CommandType = CommandType.StoredProcedure;
